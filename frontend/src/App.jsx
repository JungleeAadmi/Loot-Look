    ...
    <div className="min-h-screen text-slate-200 font-sans selection:bg-indigo-500/30 relative pb-20">
      ...
      {snipImage && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md p-4 animate-in fade-in" onClick={() => setSnipImage(null)}>
          <div className="relative h-full max-h-[90vh] flex flex-col items-center w-full">
            ...
            <img src={snipImage} alt="Snip" className="h-full w-auto max-w-full object-contain rounded-lg shadow-2xl" />
          </div>
        </div>
      )}
...
const Dashboard = ({ user, token, onLogout, openSnip, openHistory, openSettings }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      {/* RESPONSIVE NAVBAR */}
      <nav className="flex flex-col lg:flex-row justify-between items-center mb-8 gap-4 glass-panel p-4 rounded-3xl">
        ...
        {/* Add Link Bar */}
        <form onSubmit={handleAdd} className="relative group w-full lg:w-[400px]">
        ...
        {/* Controls Grid - Scrollable on very small screens or flex-wrapped */}
        <div className="flex flex-wrap justify-center lg:justify-end gap-2 w-full lg:w-auto">
          ...
          <div className="relative">
            <select 
              ...
              className="appearance-none bg-white/5 border border-white/10 text-slate-300 text-xs font-semibold rounded-xl pl-3 pr-7 py-2.5 hover:bg-white/10 focus:outline-none cursor-pointer w-full"
            >
          ...
          {data.is_tracked ? (
            <div onClick={onHistory} className="cursor-pointer hover:opacity-80 transition group/price">
              ...
              <div className={`text-xl sm:text-2xl font-bold ${priceColor} tracking-tight flex items-center gap-2`}>
                ...
                {/* Small indicator icon for history */}
